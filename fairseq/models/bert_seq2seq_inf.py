...
@register_model('bert_transformer_seq2seq_inf')
class Transformer_nonautoregressive_inf(FairseqModel):
    ...
    def build_model(cls, args, task):
        ...
        return Transformer_nonautoregressive_inf(encoder, decoder)
...
@register_model_architecture('bert_transformer_seq2seq_inf', 'bert_transformer_seq2seq_inf')
...
@register_model_architecture('bert_transformer_seq2seq_inf', 'bert_transformer_seq2seq_inf_big')
