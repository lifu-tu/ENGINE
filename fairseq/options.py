...
def add_optimization_args(parser):
    ...
    group.add_argument('--infnet-toE-feed-type', type=int, default=0, metavar='N',
                            help='options how to feed the infnet outputs into energy')

    parser.add_argument('--feed-type', default =2 ,type=int, metavar='N',
...
def add_checkpoint_args(parser):
    ...
    group.add_argument('--energy_file', default='energy_saved_models/checkpoint_last.pt',
                       help='energy checkpoints')
